...
app.factory('Projects', function() {
  return {
    ...
    '5': {
        title: 'Graph Battles',
        cover: '/img/graphbattles.png',
        github: '',
        img: ['/img/graphbattles1.png',
              '/img/graphbattles2.png',
              '/img/graphbattles3.png',
              '/img/graphbattles4.png'],
        desc: 'Graph Battles is an education video game aimed at helping students better understand graphing functions.  Along with a robust tutorial section, players learn by competing head-to-head in a game that tests their comprehension of graphing concepts.',
    longDesc: 'Graph Battles is the game I\'ve been working on for the past year for Karyote, INC.  The game is a turn based game played with 2 players.  Each player starts with 4 points that are randomly placed on a graph along with a random number of blocks that serve as obstacles.  The object is to hit and destroy your opponent\'s points while attempting to avoid the blocks and your own points.  The game was originally developed by my boss and CEO, Kyle Mears.  I was brought on and tasked with building the front end UI as well as the server and database.  The game is still being developed, but it\'s hosted and playable if you\'d like to take a look.',
    tech: ['HTML',
           'CSS',
           'React',
           'Redux',
           ...
           'Express',
           'Sequlize'],
        link: 'https://www.graphbattles.com'
    }
    // '6': {
    //     title: 'Project 6',
