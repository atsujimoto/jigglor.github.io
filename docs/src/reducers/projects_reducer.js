export const projects = [
    ...
    },
    {
    	...
    	longDesc: 'Graph Battles is the game I\'ve been working on for the past year for Karyote, INC.  The game is a turn based game played with 2 players.  Each player starts with 4 points that are randomly placed on a graph along with a random number of blocks that serve as obstacles.  The object is to hit and destroy your opponent\'s points while attempting to avoid the blocks and your own points.  The game was originally developed by our CEO, Kyle Mears.  I was brought on and tasked with building the front end UI as well as the server and database.  The game is currently still in the development phase, but it\'s hosted and playable if you\'d like to take a look.',
    	tech: ['HTML',
           	   'CSS',
           	   'React',
           	   'Redux',
